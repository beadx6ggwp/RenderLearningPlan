...
vec3 v1{ 200,300 }, v2{ 650,400 }, v3{ 100,350 };
...
void gameMain() {
	...
	vec3 v4 = { v1.x,v1.y + 150,v1.z };
	vec3 v5 = { v2.x,v2.y + 150,v2.z };
	vec3 v6 = { v3.x,v3.y + 150,v3.z };
	fillTriangle(&device, v4, v5, v6, 0xFF7700);
}
