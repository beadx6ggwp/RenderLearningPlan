...
void render() {
	...
	for (auto tri : meshCube.tris)
	{
		...
		if (Vector_DotProduct(normal, vCameraRay) < 0.0f)
		{
			...
			triangle clipped[2];
			nClippedTriangles = Triangle_ClipAgainstPlane({ 0.0f, 0.0f, 2.1f }, { 0.0f, 0.0f, 1.0f }, triViewed, clipped[0], clipped[1]);
	...
	for (auto& triProjected : vecTrianglesToRaster)
	{
		...
		switch (showMode)
		{
			...
			case 1:
				...
				drawLine(&device, triProjected.p[0].x, triProjected.p[0].y, triProjected.p[1].x, triProjected.p[1].y, 0xff0000);
				drawLine(&device, triProjected.p[1].x, triProjected.p[1].y, triProjected.p[2].x, triProjected.p[2].y, 0x00ff00);
				drawLine(&device, triProjected.p[2].x, triProjected.p[2].y, triProjected.p[0].x, triProjected.p[0].y, 0x0000ff);
				break;
			case 2: {
				fillTriangle2(&device, triProjected.p[0], triProjected.p[1], triProjected.p[2], triProjected.col);
				drawTriangle(&device, triProjected.p[0], triProjected.p[1], triProjected.p[2], 0);
